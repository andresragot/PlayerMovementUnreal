...
#include "AureiCharacterMovementComponent.generated.h"
...
UCLASS()
class AUREISTAR_API UAureiCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
	...
	class FNetworkPredictionData_Client_Aurei : public FNetworkPredictionData_Client_Character
	{
	public:
		FNetworkPredictionData_Client_Aurei(const UCharacterMovementComponent& ClientMovement);
